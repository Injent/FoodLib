...
package me.injent.foodlib.ui.dataitemtype
...
import me.injent.foodlib.ui.screens.home.HomeViewModel
...
class DataItemTypeViewModelTest {
    ...
    fun uiState_initiallyLoading() = runTest {
        val viewModel = HomeViewModel(FakeRecipeRepository())
        assertEquals(viewModel.recipes.first(), HomeUiState.Loading)
    }
